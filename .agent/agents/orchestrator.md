...
|-------|--------|----------|
| `security-auditor` | Security & Auth | Spring Security, JWT, PayOS Webhook HMAC, OWASP |
| `penetration-tester` | Security Testing | Active vulnerability testing, red team, fuzzing |
| `backend-specialist` | Backend & API | Java 17 LTS, Spring Boot 3.x, Spring Data JPA, REST |
| `frontend-specialist` | Frontend & UI | React 18 JSX, Vite, Tailwind CSS, components |
| `test-engineer` | Testing & QA | JUnit 5, Jazzer Fuzzing, Vitest, TDD |
| `devops-engineer` | DevOps & Infra | Maven build, Vite bundle, XAMPP MySQL, deployment |
| `database-architect` | Database & Schema | MySQL 8 (port 3306), JPA entities, indexes |
| `mobile-developer` | Mobile Apps | Responsive mobile web, touch interactions |
| `api-designer` | API Design | RESTful API, DTOs, endpoint contracts (port 8080) |
| `debugger` | Debugging | Root cause analysis, systematic debugging |
| `explorer-agent` | Discovery | Codebase exploration, dependencies |
| `documentation-writer` | Documentation | **Only if user explicitly requests docs** |
| `performance-optimizer` | Performance | Profiling, query optimization, bottlenecks |
| `project-planner` | Planning | Task breakdown, milestones, roadmap |
| `seo-specialist` | SEO & Marketing | SEO optimization, meta tags, analytics |
| `game-developer` | Game Development | Interactive sports widgets, physics |
...
|-------|--------|-----------|
| `frontend-specialist` | Components (.jsx), UI, styles, hooks | ❌ Test files, backend controllers, DB |
| `backend-specialist` | Spring Boot controllers, services, repositories | ❌ UI components, frontend styles |
| `test-engineer` | Test files (JUnit 5, Jazzer, test.jsx), mocks | ❌ Production feature code |
| `mobile-developer` | Mobile responsive layouts, touch UX | ❌ Backend logic |
| `database-architect` | MySQL 8 schema, JPA entities, indexes | ❌ Frontend UI |
| `security-auditor` | Security audit, JWT auth, webhook validation | ❌ Feature code, UI |
| `devops-engineer` | Maven/Vite build scripts, server configs | ❌ Application logic |
| `api-designer` | REST API endpoint specs, DTO contracts | ❌ UI code |
| `performance-optimizer` | Profiling, query optimization, caching | ❌ New features |
| `seo-specialist` | Meta tags, SEO config, analytics | ❌ Business logic |
| `documentation-writer` | Docs, README, comments | ❌ Code logic, **auto-invoke without explicit request** |
| `project-planner` | PLAN.md, task breakdown | ❌ Code files |
| `debugger` | Bug fixes, root cause | ❌ New features |
| `explorer-agent` | Codebase discovery | ❌ Write operations |
| `penetration-tester` | Security testing, fuzzing | ❌ Feature code |
| `game-developer` | Interactive widgets | ❌ Core web components |

### File Type Ownership

| File Pattern | Owner Agent | Others BLOCKED |
|--------------|-------------|----------------|
| `**/*Test.java`, `**/*.test.jsx` | `test-engineer` | ❌ All others |
| `**/components/**/*.jsx`, `**/pages/**/*.jsx` | `frontend-specialist` | ❌ backend, test |
| `**/controller/**`, `**/service/**` | `backend-specialist` | ❌ frontend |
| `**/repository/**`, `**/model/**`, `**/entity/**` | `database-architect` | ❌ frontend |
...
```
❌ WRONG:
frontend-specialist writes: src/test/java/com/sports/ProductServiceTest.java
→ VIOLATION: Test files belong to test-engineer

✅ CORRECT:
frontend-specialist writes: frontend/src/components/ProductCard.jsx
→ THEN invokes test-engineer
test-engineer writes: frontend/src/components/ProductCard.test.jsx
```
...
✅ RIGHT: "The bug is in com/sports/security/JwtUtil.java line 45 — the token expiry
