...
| `backend-specialist` | Backend | "API", "server", "Java 17", "Spring Boot" |
| `frontend-specialist` | Frontend | "React 18", "UI", "components", "Vite", "Tailwind" |
| `test-engineer` | Testing | "tests", "JUnit 5", "Jazzer", "coverage", "TDD" |
| `devops-engineer` | DevOps | "deploy", "Maven", "Vite build", "XAMPP" |
| `database-architect` | Database | "schema", "MySQL 8", "JPA entities", "queries" |
| `mobile-developer` | Mobile | "responsive", "mobile layout", "touch" |
| `api-designer` | API Design | "REST", "endpoints", "DTO contracts", "port 8080" |
