...
| --------------- | ------------------------------------------ | ----------------------- |
| **Security**    | auth, login, jwt, password, hash, payos, hmac | `security-auditor`   |
| **Frontend**    | component, react, jsx, css, html, tailwind, ui | `frontend-specialist`  |
| **Backend**     | java, spring, boot, controller, service, api | `backend-specialist`   |
| **Mobile**      | mobile, responsive, touch                  | `mobile-developer`      |
| **Database**    | mysql, jpa, entity, repository, query      | `database-architect`    |
| **Testing**     | test, junit, mockito, jazzer, fuzzing      | `test-engineer`         |
| **DevOps**      | maven, vite, build, server, xampp          | `devops-engineer`       |
| **Debug**       | error, bug, crash, not working, issue      | `debugger`              |
| **Performance** | slow, lag, optimize, cache, query index    | `performance-optimizer` |
| **SEO**         | seo, meta, analytics, sitemap, robots      | `seo-specialist`        |
| **Badminton**   | racket, specs, 3u, 4u, balance point       | `frontend-specialist`   |
